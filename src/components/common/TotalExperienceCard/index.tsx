    ...
    <Card className="mt-6">
      <CardHeader>
        <CardTitle className="text-2xl text-gray-800 text-center">
          {isDetailedView ? 'Total Experience' : 'Experience Gained'}
        </CardTitle>
      </CardHeader>
      <CardContent>
        {isCalculating ? (
          ...
          <div className="space-y-6">
            ...
            {isDetailedView && (
              <>
                {/* XP Breakdown - Only for detailed view */}
                ...
                {/* Level Progress - Only for detailed view */}
                <Card className="bg-gradient-to-r from-blue-50 to-indigo-50">
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      ) : result.days_needed > 0 && result.days_needed < Number.MAX_SAFE_INTEGER ? (
                        <div className="flex justify-between items-center mt-3">
                          <span className="text-gray-700">Days to Target Level</span>
                          <span className="font-semibold text-blue-600">
                            {result.days_needed} day{result.days_needed !== 1 ? 's' : ''}
                          </span>
                        </div>
                      ) : null}
                    </div>
            ...
            {/* Action Buttons - Only for detailed view */}
