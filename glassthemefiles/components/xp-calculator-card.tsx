  ...
  return (
    <Card
      ...
      className={cn(
        ...
        "border-red-500/60", // Added red border like white theme
        isSelected
          ? "border-primary/60 bg-gradient-to-br from-primary/20 via-primary/10 to-transparent shadow-lg shadow-primary/25"
      ...
      <CardContent className="p-6 relative z-10">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-semibold text-foreground mb-1 text-balance">{title}</h3>
